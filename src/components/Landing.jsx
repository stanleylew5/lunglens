        ...
        <div className="bg-gradient-to-b from-regalblack from-0% via-regalblack via-75% to-regalpurple to-100% h-screen">
            ...
            <div className="text-white pt-28">
                ...
                opacity: {type: 'tween', ease: 'easeOut', duration: 1.4},
                    ...
                    <p className="text-center text-xl font-bold">"Over 50% of Asian American females diagnosed with lung cancer have never smoked."</p>
                    <p className="text-center text-xl">UCSF Helen Diller Family Comprehensive Cancer Center</p>
                </motion.div>
                <motion.div className="grid grid-cols-10 my-16 mx-24 shadow-3xl shadow-regalmagenta/50 items-center border-1 py-4" 
                ...
                opacity: {type: 'tween', ease: 'easeOut', duration: 1.4},
                    ...
                    <div className="row-span-2 px-6 text-center col-span-5">
                        ...
                        <button className="border-2 mx-52 rounded-xl py-2 px-8 mt-8 shadow-regalmagenta/50 hover:shadow-regalhovermagenta/50 shadow-3xl">
