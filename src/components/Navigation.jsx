...
import dumplogo from "../../public/images/dumplogo.ico"
    ...
    <Navbar collapseOnSelect expand="md" fixed="top" className="py-2 px-3 m-0 min-h-[8vh] drop-shadow-lg flex justify-between md:min-h-[5vh]">
      <Navbar.Brand>
        <Link className="flex flex-grow md:px-3 space-x-1.5 md:space-x-2.5" style={{ textDecoration: "none" }} href="/">
            <Image src={dumplogo.src} height={75} width={75} alt="dumplogo" className="mr-6"/>
            <p className="bg-clip-text text-transparent text-4xl bg-gradient-to-b from-textpurple from-20% via-textmidpink via-80% to-textpink to-100% mt-2">HerLungs</p>
        </Link>
      </Navbar.Brand>
